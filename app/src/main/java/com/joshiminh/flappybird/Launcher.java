...
public class Launcher {
  ...
  private static class LauncherFrame extends JFrame {
    ...
    LauncherFrame() {
      ...
      JButton playBtn =
          new JButton("Play", new ImageIcon(ResourceUtil.getResource("/images/StartButton.png")));
      playBtn.setFont(font);
      JButton twoBtn =
          new JButton("2-Player", new ImageIcon(ResourceUtil.getResource("/images/bird.png")));
      twoBtn.setFont(font);
      JButton scoreBtn =
          new JButton("ScoreBoard", new ImageIcon(ResourceUtil.getResource("/images/Shift.png")));
      scoreBtn.setFont(font);
      JButton exitBtn =
          new JButton("Exit", new ImageIcon(ResourceUtil.getResource("/images/pause.png")));
  ...
  private static void startTwoPlayerGame(
      String playerOneName, String playerTwoName, String theme, int diff, ImageIcon birdIcon) {
    JFrame frame = new JFrame("Flappy Bird");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    frame.setSize(800, 600);
    frame.setResizable(false);
